          ...
          <div className="QR-container">
            <div className="clover-QR">
              <div className="clover-qr-img">
                <img
                  src="https://ik.imagekit.io/shadows/Shadows-project/CloverQR.png"
                  alt=""
                ></img>
              </div>
            ...
            <div className="PayPal-QR">
              <div className="paypal-qr-img">
                <img
                  src="https://ik.imagekit.io/shadows/Shadows-project/PaypalQR.png"
                  alt=""
                ></img>
              </div>
              ...
              <div className="paypal-info">
                ...
                <Link
                  to="https://paypal.com/qrcodes/managed/9a084d4b-a535-4f6e-869b-d0329c36a2f6?utm_source=payandgetpaid"
                  target="_blank"
                  rel="noreferrer"
                >
